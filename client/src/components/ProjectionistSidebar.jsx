...
import { Briefcase, CalendarClock, FileUser, FilmIcon, IdCardLanyard, LayoutDashboardIcon, StickyNote, TicketIcon } from 'lucide-react'

const ProjectionistSidebar = () => {
  const user = {
    firstName: 'Projectionist',
    lastName: 'User',
    imageUrl: assets.profile
  }

  const managerNavlinks = [
    { name: 'Dashboard', path: '/projectionist', icon: LayoutDashboardIcon },
    { name: 'Quản lý phòng chiếu', path: '/projectionist/qlpc', icon: FilmIcon },
    { name: 'Quản lý lịch chiếu', path: '/projectionist/qllc', icon: CalendarClock },
...
export default ProjectionistSidebar