...
import { CalendarClock, Clapperboard, FilmIcon, HouseWifi, LayoutDashboardIcon, User2Icon, UserLock } from 'lucide-react'
...
const AdminSidebar = () => {
  ...
  const adminNavlinks = [
    ...
    { name: 'Quản lý Phân quyền', path: '/admin/qlpq', icon: UserLock },
