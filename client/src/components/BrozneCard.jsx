...
const SilverCard = ({
  ...
  return (
    <div className="w-[500px] h-[300px] bg-gradient-to-tr from-orange-600 to-orange-400 rounded-xl shadow-2xl p-6 relative overflow-hidden text-black font-sans">
      {/* Tier */}
      <div className="text-3xl font-extrabold tracking-wide mb-4">Bronze</div>
